...
export const messages = {
	en: {
		...
		"roles.permissionGroup.integrations": "Integrations",
		...
		"permissions.mcp.manage": "Manage MCP server",
		...
		"mcp.grantsEmpty": "You have not authorized any MCP clients.",
		"mcp.revoke": "Revoke",
		"mcp.consentTitle": "Authorize MCP access",
		"mcp.consentDescription":
			"This client wants to use Shorty Link on your behalf. It will only receive the tools your role already allows.",
		"mcp.consentClient": "Client",
		"mcp.consentScopes": "Requested scopes",
		"mcp.consentAllow": "Allow",
		"mcp.consentDeny": "Deny",
		"mcp.unknownClient": "Unknown client",
	...
	es: {
		...
		"roles.permissionGroup.integrations": "Integraciones",
		...
		"permissions.mcp.manage": "Gestionar servidor MCP",
		...
		"errors.mcpDisabled": "El servidor MCP esta desactivado.",
		...
		"mcp.grantsEmpty": "No has autorizado ningun cliente MCP.",
		"mcp.revoke": "Revocar",
		"mcp.consentTitle": "Autorizar acceso MCP",
		"mcp.consentDescription":
			"Este cliente quiere usar Shorty Link en tu nombre. Solo recibira las herramientas que tu rol ya permite.",
		"mcp.consentClient": "Cliente",
		"mcp.consentScopes": "Alcances solicitados",
		"mcp.consentAllow": "Permitir",
		"mcp.consentDeny": "Denegar",
		"mcp.unknownClient": "Cliente desconocido",
