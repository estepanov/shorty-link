/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 047c44b36bacc35f5c91a472d8d669ef)
...
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		AI: Ai;
		BETTER_AUTH_ALLOWED_HOSTS: "localhost:3000,localhost:8787,*.workers.dev";
		BETTER_AUTH_FALLBACK_URL: "http://localhost:3000";
		PASSKEY_RP_NAME: "Shorty Link";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_ALLOWED_HOSTS" | "BETTER_AUTH_FALLBACK_URL" | "PASSKEY_RP_NAME">> {}
}
